...
@Component({
  selector: 'app-add-edit-spell-assemblyline',
  templateUrl: './add-edit-spell-assemblyline.component.html',
  styleUrls: ['./add-edit-spell-assemblyline.component.scss']
})
export class AddEditSpellAssemblylineComponent {
    ...
    updateAssemblyLine() {
        ...
        this.service.updateSpellAssemblyLineData(plan).subscribe({
          next: (response) => {
